# Python Classification Template with Jupyter notebooks

This is a dockerized ML model for binary and multiclass classification. The purpose of this project is to provide a functional model that can be used as a template for building your own classification model. The model is implemented in Jupyter notebooks for training and batch prediction tasks.
